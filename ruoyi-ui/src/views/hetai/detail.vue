    ...
    <div id="app">
        <el-container>
            ...
            <div v-if="hasData">
                ...
                <el-row :gutter="10" style="margin-left: 5rem;margin-top:4rem;font-size:1.3rem;color:#5A5A5A">
                    <el-col :xs="22" :sm="22" :md="22" :lg="22" :xl="22">
                        <div class="grid-content bg-purple" v-if="data.attachmentUrl">
                            附件: <el-button size="mini" type="text" icon="el-icon-edit"
                                @click="$download.resource(data.attachmentUrl, false)"> {{ data.attachmentName
                                }}</el-button>
                        </div>
                    </el-col>
                </el-row>
